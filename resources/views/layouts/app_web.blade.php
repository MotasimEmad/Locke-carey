    ...
    <footer class="bg-red-500 text-white">
        <div class="container px-4 py-4">
            <div class="w-full px-6 flex flex-col md:flex-row justify-between">
                <div>
                    <div>
                        <a href="#" class="text-xl font-bold text-white hover:text-gray-200">LockeCarey</a>
                    </div>
                    
                    <p class="max-w-md mt-2 text-gray-100">Join 60+ companies & Inventores.</p>
                    
                    <div class="flex mt-4 -mx-2">
                        <a target="_blank" href="https://www.linkedin.com/company/locke-carey-fire-safety-consultancy/" class="mx-2 text-white hover:text-gray-200" aria-label="Linkden">
